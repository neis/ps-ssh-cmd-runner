...
# ---------------------------------------------
# PURE-CORE LIBRARY
# Dot-source the pure, side-effect-free helper functions so they are available
# both here and to the Pester unit tests. Must load before first use of any
# moved function (Resolve-DeviceCommandList, Test-IsAuthFailure,
# ConvertTo-CmdEchoEscaped, Get-HostnameFromPrompt, ConvertTo-SafeFileName).
# ---------------------------------------------
...
function Set-AskPassScript {
    ...
    $escaped = ConvertTo-CmdEchoEscaped $Password
